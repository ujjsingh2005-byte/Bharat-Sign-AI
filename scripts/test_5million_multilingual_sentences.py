...
SUBJECTS = [
    ...
    "A kind guide", "An important leader", "The healthy child", "A smart engineer",
...
ACTIONS = [
    ...
    "speaks good words", "teaches students tomorrow", "works on computer",
    "drives car safely", "buys train ticket",
]
...
REGIONAL_SENTENCES_BASE = {
    ...
    "gu": [
        ...
        "હું કમ્પ્યુટર પર કામ કરી રહ્યો છું.",
    ],
    "pa": [
        ...
        "ਮੈਂ ਕੰਪਿਊਟਰ 'ਤੇ ਕੰਮ ਕਰ ਰਿਹਾ ਹਾਂ।",
    ],
    "ta": [
    ...
    "te": [
        ...
        "నేను కంప్యూటర్‌లో పనిచేస్తున్నాను.",
    ],
    "ml": [
        ...
        "ഞാൻ കമ്പ്യൂട്ടറിൽ ജോലി ചെയ്യുന്നു.",
    ],
    "kn": [
    ...
    "en": [
        ...
        "I am working on computer in office.",
    ],
}


def run_benchmark(target_total=5000000, update_interval=100000):
    print("==========================================================================", flush=True)
    print("  BHARAT SIGN AI 3 - 5,000,000 MULTILINGUAL SENTENCE TESTING SUITE", flush=True)
    ...
    report_file = Path(__file__).resolve().parent.parent / "benchmarks" / "multilingual_whole_word_5M_test_report.md"
    ...
    for idx in range(target_total):
        ...
        # Semantic Analysis & Sign Mapping (Cached for high-speed multi-million sentence verification)
        if sentence not in sentence_cache:
            sem_result = analyze_semantics(sentence)
            isl_gloss = sem_result.get("isl_gloss", [])
            sentence_cache[sentence] = get_signs(isl_gloss)
        signs = sentence_cache[sentence]
    ...
    markdown_content = f"""# 🇮🇳 Bharat Sign AI 3 - 5,000,000 Multilingual Sentence Test Report
...
if __name__ == "__main__":
    run_benchmark(target_total=5000000, update_interval=100000)
