...
SUBJECTS = [
    ...
    "A kind guide", "An important leader", "The healthy child",
]
...
def run_benchmark(target_total=3000000, update_interval=100000):
    print("==========================================================================", flush=True)
    print("  BHARAT SIGN AI 3 - 3,000,000 MULTILINGUAL SENTENCE TESTING SUITE", flush=True)
    ...
    report_file = Path(__file__).resolve().parent.parent / "benchmarks" / "multilingual_whole_word_3M_test_report.md"
    ...
    markdown_content = f"""# 🇮🇳 Bharat Sign AI 3 - 3,000,000 Multilingual Sentence Test Report
...
if __name__ == "__main__":
    run_benchmark(target_total=3000000, update_interval=100000)
